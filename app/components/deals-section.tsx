...
function DealCard({ product, accent }: { product: Product; accent: "blue" | "dark" }) {
  ...
  return (
    <article className="overflow-hidden rounded-[8px] border border-[#bcd9ef] bg-white shadow-[0_12px_35px_rgba(0,104,200,0.08)] transition duration-200 hover:-translate-y-1 hover:shadow-[0_18px_44px_rgba(0,104,200,0.15)]">
      <div className="grid gap-5 p-4 sm:p-5 lg:grid-cols-[210px_1fr]">
        <Link
          href={`/product/${product.id}`}
          className="relative flex min-h-[220px] items-center justify-center overflow-hidden rounded-[6px] bg-[#f6f9fc] sm:min-h-[250px] lg:min-h-full"
        >
        ...
        <div className="flex min-w-0 flex-col justify-center">
          ...
          <h3 className="mt-2 max-w-xl text-xl font-black leading-tight text-black sm:text-2xl">
